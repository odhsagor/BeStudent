        ...
        <div class="container">
            <div class="row footer-main">
                <div class="col-md-4 mb-4 mb-md-0">
                    <h5 class="footer-heading">About BeStudent</h5>
                    <p class="footer-text">BeStudent is a leading educational platform providing high-quality learning resources for students worldwide.</p>
                ...
                <div class="col-md-4">
                    ...
                    <ul class="footer-links">
                        <li><i class="fas fa-envelope me-2"></i> info@bestudent.edu</li>
            ...
            <div class="footer-bottom">
                <div class="row">
                    <div class="col-md-6">
                        <p class="copyright">&copy; 2023 BeStudent. All rights reserved.</p>
                    </div>
